            ...
            <div className="bg-white bg-opacity-95 p-6 rounded-lg shadow-xl">
              ...
              <div className="prose max-w-none">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-blue-600 font-comic m-0">Baccha💗,</h3>
                </div>
                <div className="space-y-3 font-comic text-gray-700 leading-relaxed">
                  <p>
                    I know mere se bhot bdi glti hui mujhe hmri personal life kisi ki advice nhi leni chiye thi kisi se bhii please jaana is baar maaf krdoo
                  </p>
                  <p>
                    M wada krta hu ki aage m ek behtar insan bnunga 
                  </p>
                  <p>
                    Please sorry
                  </p>
